...
-- -----------------------------------------------------
-- Table `affablebean`.`msg_subject`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `affablebean`.`msg_subject` ;
...
DROP TABLE IF EXISTS `affablebean`.`msg_feedback` ;
...
CREATE  TABLE IF NOT EXISTS `affablebean`.`msg_feedback` (
  ...
  CONSTRAINT `fk_msg_subject`
    ...
    REFERENCES `affablebean`.`msg_subject` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
